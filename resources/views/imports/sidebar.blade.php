<aside id="sidebar" class="collapse collapse-horizontal show sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#Registration" aria-expanded="false"
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="students">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin-admission') }}"><i
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="payment">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('cbcPage') }}"><i
                                class="fas fa-file-medical pe-2"></i>CBC</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('urinalysisPage') }}"><i
                                class="fas fa-file-medical pe-2"></i>Urinalysis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fecalysisPage') }}"><i
                                class="fas fa-file-medical pe-2"></i>Fecalysis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('xrayPage') }}"><i class="fas fa-file-medical pe-2"></i>Chest
                            X-ray(PA)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('antigenPage') }}"><i
                                class="fas fa-file-medical pe-2"></i>Heppa B Antigen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('vaccinePage') }}"><i
