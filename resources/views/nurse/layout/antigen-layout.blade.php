...
<script>
    ...
    new Vue({
        ...
        mounted() {
            ...
            this.sampleDate = localStorage.date ? localStorage.date : "01/01/1970";
        ...
        computed: {
            formattedDate() {
                if (this.sampleDate) {
                    const [year, month, day] = this.sampleDate.split('/');
        ...
        methods: {
            ...
            submitAntigen() {
                ...
                if (this.result.trim() === "") {
                    this.errors.result = "Please enter the result.";
                }
                ...
                newData.append('sampleDate', this.formattedDate)
                newData.append('result', this.result)
                console.log(newData);
                axios.post("{{ route('storeAntigen') }}", newData)
                    .then(response => {
                        ...
                        setTimeout(() => {
                            this.$message({
                                message: 'New Heppa B Antigen form has been added successfully!',
                                type: 'success'
                            });
