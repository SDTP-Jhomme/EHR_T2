            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="payment">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('cbcForms')}}"><i class="fas fa-file-medical pe-2"></i>CBC</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('urinalysisForms')}}"><i class="fas fa-file-medical pe-2"></i>Urinalysis</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('fecalysisForms')}}"><i class="fas fa-file-medical pe-2"></i>Fecalysis</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('xrayForms')}}"><i class="fas fa-file-medical pe-2"></i>X-ray</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('antigenForms')}}"><i class="fas fa-file-medical pe-2"></i>Hepa Antigen</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('vaccineForms')}}"><i class="fas fa-file-medical pe-2"></i>Hepa Vaccine</a>
                            </li>
                        </ul>
                    </div>
                </li>
