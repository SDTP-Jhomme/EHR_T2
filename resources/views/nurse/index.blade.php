<!DOCTYPE html>
<html lang="en">
@extends('nurse/layout/login-layout')
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 right-fade-in">
                    <div class="form-group mb-4">
                        <input v-on:keyup.enter="login" type="text" id="identification" class="form-control" placeholder="Nurse Identification" :class="{'has-error': this.userErr}" v-model="identification" />
