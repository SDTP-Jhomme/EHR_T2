@extends('nurse/medical-records/layout/antigen-layout')
<!DOCTYPE html>
<html lang="en">
...
<div id="app">
    ...
    <main class="main-panel flex-lg-grow-1">
        ...
        <!----------------------------------------------------------------------------------- Modals/Drawers ----------------------------------------------------------------------------------->
        <!-- View Dialog -->
        <el-dialog v-for="antigen in isAntigen" :visible.sync="viewDialog" width="50%" :before-close="closeViewDialog">
            <template #title>
