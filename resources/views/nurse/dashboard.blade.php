                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center align-items-center g-2 my-5">
                                <div class="col-12">
                                    <el-button class="btn-block" type="primary" @click="changePass = true">Change
                                        Password
                                    </el-button>
                                </div>
                            </div>
                                ...
                                <div class="col-12" v-if="changePass">
                                    ...
                                    <div class="" v-else>
                                        ...
                                        <div class="row justify-content-center align-items-center g-2 mb-2">
                                            <div class="col-12">
                                                ...
                                                <el-input placeholder="" v-model="confirmPassword" show-password>
                                                </el-input>
                                    ...
                                    <div class="row justify-content-center align-items-center g-2 mt-2">
                                        <div class="col-12" v-if="checkPass">
                                            <button class="btn btn-primary" v-if="loadButton" disabled><i
                                                    class="el-icon-loading"></i> Loading</button>
                                            <button class="btn btn-primary" v-else @click="updatePassword">Update
                                                Password</button>
                                            <button class="btn btn-secondary" @click="resetPassword">Reset Form</button>
                                            <button class="btn btn-secondary"
                                                @click="cancelUpdatePassword">Cancel</button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="row justify-content-between align-items-center g-2 mb-3">
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/cbc.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Complete Blood Count</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.cbcCount"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/urinalysis.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Urinalysis</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.countUrine"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/fecalysis.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Fecalysis</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.countfecal"></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row justify-content-between align-items-center g-2 mb-4">
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/x-ray.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Chest X-ray (PA)</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.countXray"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/hepa-antigen.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Heppa B Antigen</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.countAntigen"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top w-25 mx-auto" src="<?php echo asset('assets/img/hepa-vaccine.png'); ?>"
                                                        alt="Title">
                                                    <div class="card-body text-center">
                                                        <h4 class="card-title">Heppa B Vaccine</h4>
                                                        <p class="card-text fs-2"><i
                                                                class="fas fa-poll me-3 text-muted"></i><span
                                                                class="text-muted" v-text="this.countVaccine"></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                                    ...
                                                    <div class="col-12 grid-margin stretch-card">
                                                        <div class="card w-100 rounded">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mt-3">
                                                                    <canvas ref="chartCanvas" id="formChart"
                                                                        style="height: 370px; width: 95%;"></canvas>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-8 col-lg-4 d-flex flex-column">
                                                <div class="card w-100 rounded">
                                                    <div class="card-body">
                                                        <div
                                                            class="d-sm-flex justify-content-between align-items-start border-bottom">
                                                            <div>
                                                                <h4 class="card-title card-title-dash text-muted">
                                                                    Medical Records Overview</h4>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3">
