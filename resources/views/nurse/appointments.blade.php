                            ...
                            <div class="row justify-content-center align-items-center g-2">
                                <div class="col-auto">
                                    <el-tooltip class="item" effect="dark" :content="scope.row.med_status == 'Approved' ? 'Declined' : 'Approved'" placement="top-start">
                                        <!-- <el-button icon="el-icon-check" size="mini" type="success" @click="handleApprove(scope.$index, scope.row)"></el-button> -->
                                ...
                                <div class="col-auto">
                                    <el-tooltip class="item" effect="dark" :content="scope.row.med_status == 'Declined' ? 'Approved' : 'Declined'" placement="top-start">
                                        <!-- <el-button icon="el-icon-close" size="mini" type="danger" @click="handleDecline(scope.$index, scope.row)"></el-button> -->
