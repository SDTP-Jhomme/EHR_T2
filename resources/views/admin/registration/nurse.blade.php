    ...
    <main class="main-panel flex-lg-grow-1">
        ...
        <el-drawer title="Add Nurse" :visible.sync="openAddDrawer" size="70%" :before-close="closeAddDrawer">
                    ...
                    <div class="row justify-content-start align-items-center g-2">
                        ...
                        <div class="col">
                            <el-form-item label="Birthday" prop="birthdate">
                                <el-date-picker v-model="addNurse.birthdate" type="date" placeholder="Select birthdate" :picker-options="birthdayOptions"clearable>
                                </el-date-picker>
                            </el-form-item>
                        </div>
                        <div class="col">
            ...
            <div class="d-flex p-4">
                <el-button :loading="loadButton" class="flex-1" type="primary" @click="addUser('addNurse')">Submit</el-button>
                <el-button :loading="loadButton" class="flex-1" @click="resetForm('addNurse')">Reset</el-button>
            </div>
        </el-drawer>
        <!-- After Add Show Nurse Username & Password -->
        <el-dialog title="New Nurse Identification and Password" :visible.sync="openAddDialog" width="30%" :before-close="closeAddDialog">
        ...
        <el-dialog :visible.sync="viewDialog" width="35%" :before-close="closeViewDialog">
            <template #title>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="fs-5">User<span class="mx-2" v-text="viewNurse.firstname"></span></div>
                    <div class="pe-4">
            ...
            <div class="container">
                <div class="">
                    <el-descriptions direction="horizontal" :column="1" border>
                        <el-descriptions-item label="Identification Number"><span class="mx-2" v-text="viewNurse.identification"></el-descriptions-item>
                        <el-descriptions-item label="Name"><span class="mx-2" v-text="viewNurse.name"></el-descriptions-item>
                        <el-descriptions-item label="Birthday"><span class="mx-2" v-text="viewNurse.birthdate"></el-descriptions-item>
                        <el-descriptions-item label="Gender">
                            <el-tag v-if="viewNurse.gender == 'Male'"><span class="mx-2" v-text="viewNurse.gender"></el-tag>
        ...
        <el-dialog :visible.sync="editDialog" width="40%" :before-close="closeEditDialog">
            <template #title>
                Edit User <span class="mx-2" v-text="editNurse.firstname"></span>
            </template>
            <el-form :label-position="leftLabel" label-width="160px" :model="updateNurse" :rules="editRules" ref="updateNurse">
                <el-form-item label="Identification Number" prop="identification">
                    <el-input v-model="updateNurse.identification" maxlength="7" onKeyup="addDashes(this)" clearable></el-input>
                </el-form-item>
                <el-form-item label="First Name" prop="firstname">
                ...
                <el-form-item label="Birthday" prop="birthdate">
                    <el-date-picker :picker-options="birthdayOptions" v-model="updateNurse.birthdate" type="date" placeholder="Select birthdate" clearable>
                    </el-date-picker>
                </el-form-item>
                <el-form-item label="Gender" prop="gender">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button :loading="loadButton" type="primary" @click="updateUser('updateNurse')">Update</el-button>
            </span>
        </el-dialog>
    </main>
    @endsection
