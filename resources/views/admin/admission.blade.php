        ...
        <main class="main-panel flex-lg-grow-1">
                ...
                <div class="container-fluid border rounded p-4 mb-2">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ps-2">
                                ...
                                <div v-else-if="searchValue == 'status'">
                                    <el-input v-model="searchStatus" size="mini" placeholder="Type to search..."
                                        clearable />
                                </div>
                                <div v-else-if="searchValue == 'yearandsection'">
                                    <el-input v-model="searchYrandSect" size="mini" placeholder="Type to search..."
                                        clearable />
                                </div>
                                <div v-else>
                    ...
                    <el-table v-if="this.tableData" :data="usersTable" style="width: 100%" border height="500"
                        ...
                        <el-table-column sortable label="Year and Section" width="250" prop="yearandsection">
                            <template slot-scope="scope">
                                <el-tag size="small" v-if="scope.row.year == 'Fourth Year'"><span
                                        v-text="scope.row.yearandsection"></span></el-tag>
                                <el-tag size="small" type="warning" v-if="scope.row.year == 'First Year'"><span
                                        v-text="scope.row.yearandsection"></span></el-tag>
                                <el-tag size="small" type="success" v-if="scope.row.year == 'Second Year'"><span
                                        v-text="scope.row.yearandsection"></span></el-tag>
                                <el-tag size="small" v-if="scope.row.year == 'Third Year'" type="danger"><span
                                        v-text="scope.row.yearandsection"></span></el-tag>
                            </template>
                        </el-table-column>
            ...
            <el-drawer title="Add Student" :visible.sync="openAddDrawer" size="50%" :before-close="closeAddDrawer">
                        ...
                        <div class="row justify-content-start align-items-center g-2">
                            <div class="col">
                                <el-form-item label="Identification Number" prop="identification">
                                    <el-input v-model="addStudent.identification" maxlength="7"
                        ...
                        <div class="row justify-content-start align-items-center g-2">
                            ...
                            <div class="col">
                                <el-form-item label="Birthday" prop="birthdate">
                                    <el-date-picker v-model="addStudent.birthdate" type="date"
                ...
                <div class="d-flex p-4">
                    <el-button :loading="loadButton" class="flex-1" type="primary" @click="addUser('addStudent')">
                        Submit</el-button>
            ...
            <el-dialog :visible.sync="viewDialog" width="35%" :before-close="closeViewDialog">
                <template #title>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="fs-5">Nursing Student:<span class="mx-2" v-text="viewStudent.firstname"></span>
                        </div>
                        <div class="pe-4">
            ...
            <!-- Edit Dialog -->
            <el-drawer :direction="direction" :visible.sync="editDialog" size="50%" :before-close="closeEditDialog">
                <template #title>
                    <div class="fs-5 mb-3">Edit Student:<span class="mx-2" v-text="editStudent.firstname"></span>
                    </div>
                </template>
                <div class="container m-0">
