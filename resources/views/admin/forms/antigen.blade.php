@extends('admin/layout/antigen-layout')
<!DOCTYPE html>
<html lang="en">
...
<body>
    @section('content')
    <div class="container-fluid" v-if="this.isAntigen">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form class="mb-4" @submit.prevent="submitAntigen">
                            @csrf
                            <div class="row align-items-center g-2 my-2">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="text-danger" v-text="errors.result"></div>
                                    </div>
                                </div>
                            </div>
