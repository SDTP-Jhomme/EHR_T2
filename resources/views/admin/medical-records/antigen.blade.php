@extends('admin/medical-records/layout/antigen-layout')
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="app">
        ...
        <div class="container-fluid page-wrapper">
            ...
            <main class="main-panel flex-lg-grow-1">
                <el-main>
                    <div class="container border rounded p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <p class="mb-0">Heppa B Antigen Information Table</p>
                            <div class="d-flex">
                                ...
                                <div class="ps-2">
                                    <div v-if="searchValue == 'identification'">
                                        <el-input v-model="searchID" size="mini" placeholder="Type to search..."
                                            clearable />
                                    </div>
                ...
                <!----------------------------------------------------------------------------------- Modals/Drawers ----------------------------------------------------------------------------------->
                <!-- View Dialog -->
                <el-dialog v-for="antigen in isAntigen" :visible.sync="viewDialog" width="50%"
                    :before-close="closeViewDialog">
                    <template #title>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="fs-5">User<span class="mx-2" v-text="viewStudent.firstname"></span></div>
                            <div class="pe-4">
                                <el-avatar :size="70" :src="antigen.avatar"></el-avatar>
                            </div>
                        </div>
                    </template>
                    <div class="container">
