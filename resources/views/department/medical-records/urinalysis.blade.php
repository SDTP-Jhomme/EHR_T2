@extends('department/medical-records/layout/urinalysis-layout')
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    @section('title', 'Urinalysis Record')
</head>
    ...
    @include('department/imports/nav')
        <div class="container mt-3">
            <div class="row justify-content-center align-items-center g-2">
                <div class="col ms-auto"><h3>Urinalysis List</h3></div>
        ...
        <!----------------------------------------------------------------------------------- Modals/Drawers ----------------------------------------------------------------------------------->
        <!-- View Dialog -->
        <el-dialog v-for="urine in isUrinalysis" :visible.sync="viewDialog" width="75%" :before-close="closeViewDialog">
            <template #title>
                ...
                <div class="card">
                    <div class="card-body content">
                        ...
                        <div class="container">
                            ...
                            <div class="card">                
                                <div class="card-body">
                                    <img :src="urine.result" class="img-fluid rounded-top" alt="Antigen Result">
                                </div>
                            </div>
                        </div>
                    </div>
