...
<body>
    ...
    @include('department/imports/nav')
        ...
        <!----------------------------------------------------------------------------------- Modals/Drawers ----------------------------------------------------------------------------------->
        <!-- View Dialog -->
        <el-dialog v-for="vaxx in isVaxx" :visible.sync="viewDialog" width="75%" :before-close="closeViewDialog">
            <template #title>
                ...
                <div class="card">
                    <div class="card-body content">
                        ...
                        <div class="container">
                            ...
                            <div class="card">                
                                <div class="card-body">
                                    <img :src="vaxx.result" class="img-fluid rounded-top w-100" alt="Antigen Result">
                                </div>
                            </div>
                        </div>
                    </div>
