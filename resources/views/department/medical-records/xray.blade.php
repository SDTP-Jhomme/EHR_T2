@extends('department/medical-records/layout/xray-layout')
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    @section('title', 'Chest X-ray Record')
</head>
    ...
    @include('department/imports/nav')
        <div class="container mt-3">
            <div class="row justify-content-center align-items-center g-2">
                <div class="col ms-auto"><h3>Chest X-ray List</h3></div>
        ...
        <!----------------------------------------------------------------------------------- Modals/Drawers ----------------------------------------------------------------------------------->
        <!-- View Dialog -->
        <el-dialog v-for="xray in isXray" :visible.sync="viewDialog" width="75%" :before-close="closeViewDialog">
            <template #title>
